            ...
            using (StreamWriter writer = new StreamWriter(codePath))
            {
                ...
                while (reader.Read(currentInstruction, 0, 2) != 0)
                {
                    ...
                    switch (opcode & 0xF000)
                    {
                        ...
                        case 0x1000:
                            writer.Write("Jump to address 0x" + instructionString.Substring(1));
                            break;
                        ////2NNN - Calls subroutine at NNN
                        case 0x2000:
                            writer.Write("Call subroutine at 0x" + instructionString.Substring(1));
                            break;
                        //3XNN - Skip the next instruction if RX equals NN
                        case 0x3000:
                            writer.Write("Skip the next instruction if the value at R" + instructionString[1] + " equals 0x" + instructionString.Substring(2));
                            break;
                        ...
                        case 0x6000:
                            writer.Write("Set the value of R" + instructionString[1] + " to 0x" + instructionString.Substring(2));
                            break;
                        //7XNN - Adds NN to the value stored at RX
                        case 0x7000:
                            writer.Write("Adds the value of 0x" + instructionString.Substring(2) + " to R" + instructionString[1]);
                            break;
                        ...
                        case 0xA000:
                            writer.Write("Set the Index register to the value of 0x" + instructionString.Substring(1));
                            break;
                        //CXNN - Set RX to the result of an and operation on a random number and NN
                        case 0xC000:
                            writer.Write("Set R" + instructionString[1] + " to the result of an AND operation on a random number and 0x" + instructionString.Substring(2));
                            break;
                        ...
                        case 0xF000:
                            switch (byte2)
                            {
                                ...
                                case 0x55:
                                    writer.Write("Store R0 to R" + instructionString[1] + " to memory values starting at the address in Index");
                                    break;
